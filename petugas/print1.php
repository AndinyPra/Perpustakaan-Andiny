    ...
    <div class="container mt-4">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                $no = 1;
                $data = mysqli_query($koneksi, "SELECT * FROM peminjaman, buku, user WHERE peminjaman.id_user=user.id_user AND peminjaman.id_buku=buku.id_buku AND tgl_peminjaman >= '$tgl_peminjaman' AND (tgl_pengembalian <= '$tgl_pengembalian') AND id_peminjaman = '$id_peminjaman'");
